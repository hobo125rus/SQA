...
#@pytest.mark.skip
def test_feedback_search_tc012(base_url, browser_type):
    test_page = BrowserCls(base_url, browser_type)
    test_page.go_to_url()
    test_page.is_loaded(TestCaseConstants.Test_PageIsLoadFlag)
    feedback_page = FeedbackPageCls() 
    assert feedback_page.is_title(TestCaseConstants.Test_PageTitle) == True
...
#@pytest.mark.skip
def test_feedback_search_tc017(base_url, browser_type):
    """
...
#@pytest.mark.skip
def test_feedback_name_tc012(base_url, browser_type):
    """
...
#@pytest.mark.skip
def test_feedback_name_tc017(base_url, browser_type):
    """
    ...
    for cmd in tcconstants:
        ...
        feedback_page.click_on_the_submit_button()
        #assert test_page.is_loaded(TestCaseConstants.Test_PageIsLoadFlag) == True
        assert cmd[0] not in test_page.page_source()
        test_page.go_to_url()        
        feedback_page.name_clear()  
 
#@pytest.mark.skip        
def test_feedback_email_tc012(base_url, browser_type):
    """
...
#@pytest.mark.skip
def test_feedback_email_tc017(base_url, browser_type):
    """
...
#@pytest.mark.skip        
def test_feedback_subject_tc012(base_url, browser_type):
    """
...
#@pytest.mark.skip
def test_feedback_subject_tc017(base_url, browser_type):
    """
...
#@pytest.mark.skip        
def test_feedback_comments_tc012(base_url, browser_type):
    """
...
#@pytest.mark.skip
def test_feedback_comments_tc017(base_url, browser_type):
    """
